...
from job_scheduler.models import Job, Type, Interval
...
class JobCreator(Creator):
    ...
    def __init__(self, name: str, job_type: str, interval: int, commence_execution_at: str, class_type: str):
        self.name = name
    ...
    def operation(self):
        ...
        # if len(time_array) == 3:
        self.commence_execution_at = Utilities.covert_str_to_datetime(self.commence_execution_at)
