"""Contains a child of the parent job class."""
...
# from api.http_clients import HttpPostClient
#
...
class JobCoreService(Job):
    ...
    def do_job(self):
        ...
        post_response = requests.post("https://ims-notification.herokuapp.com/api/v1/notification",
